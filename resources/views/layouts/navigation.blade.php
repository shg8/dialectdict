    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('contribute')" :active="request()->routeIs('contribute')">
                        {{ __('Contribute') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
            ...
            <div class="flex flex-row">
                <div class="invisible lg:visible self-center pt-2 mb-2 relative mx-auto text-gray-600">
                    ...
                    <button type="button" class="absolute right-0 top-0 mt-5 mr-4" onclick="search($('#search-bar-top').val())">

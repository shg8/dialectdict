...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-indigo-700 text-md font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-900 transition duration-150 ease-in-out'

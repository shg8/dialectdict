        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-48">
                <div class="flex flex-col items-center justify-center bg-white p-12 shadow rounded-lg">
                    ...
                    <p class="text-md-left md:text-gray-500 mt-3">Noah is a high school senior from New York City, New York.</p>

                    <p class="text-md-left text-gray-700 mt-3">
                        This dictionary came from my desire to connect with my family’s heritage. My mom’s side of the family speaks a dialect of Chinese called Fuzhounese and I’ve always wanted to learn the language so I could communicate with them, especially since some of them don’t speak English. While studying online, I noticed that there were few resources for learning Fuzhounese—or any Chinese dialect besides Cantonese and Mandarin for that matter.
